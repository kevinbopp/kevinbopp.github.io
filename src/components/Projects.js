...
export const Projects = () => {
  ...
  const gameProjects = [
    {
      ...
      longDesc: "Designing and coding the front-end UI and educational games of a cross-platform mobile app to teach basic math to children.",
  ...
  const otherProjects = [
    ...
    },
    {
      ...
      longDesc: "Wrote instruction code to allow a Texas Instruments robot to successfully navigate a series of random mazes.",
